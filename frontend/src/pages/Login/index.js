...
const useStyles = makeStyles(theme => ({
  ...
  visibilityIcon: {
    color: '#6E0A78', // Cor desejada para o ícone de visibilidade da senha
  },

  supportText: {
    color: '#6E0A78', // cor fale com o suporte final da pagina
  },
  textField: {
    "& .MuiOutlinedInput-root": {
      "& fieldset": {
        borderColor: '#4B0751', // Cor da borda
      },
      "&:hover fieldset": {
        borderColor: '#4B0751', // Cor da borda ao passar o mouse
      },
      "&.Mui-focused fieldset": {
        borderColor: '#4B0751', // Cor da borda quando o campo está focado
      },
    },
    "& .MuiOutlinedInput-input": {
      color: '#4B0751', // Cor do texto no estado normal
    },
    "& .MuiInputLabel-root": {
      color: '#4B0751', // Cor do texto da label
    },
    "& label.Mui-focused": {
      color: '#4B0751', // Cor do texto quando o campo está focado
    },
  },
}));
const Login = () => {
